...
var init = function init() {
  window.onload = function () {
    if (!sessionStorage.alreadyClicked) {
      ...
      var rocketBoy = $('.preloader_rocketboy');
      var rocketBoyHeight = $('.preloader_rocketboy').height();
      var rocketBoyWidth = $('.preloader_rocketboy').width();
      rocketBoy.css({
...
/* harmony import */ var _vendor_jqueryUi_v1_13_1__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/jqueryUi_v1.13.1 */ "./src/js/vendor/jqueryUi_v1.13.1.js");
...
/* harmony import */ var _modules_fixedBlockOnMother__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/fixedBlockOnMother */ "./src/js/modules/fixedBlockOnMother.js");
/* harmony import */ var _modules_fixedBlockOnMother__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_modules_fixedBlockOnMother__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _modules_progressBar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/progressBar */ "./src/js/modules/progressBar.js");
/* harmony import */ var _modules_slowShowText__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/slowShowText */ "./src/js/modules/slowShowText.js");
...
/* harmony import */ var _modules_trackNavLocation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/trackNavLocation */ "./src/js/modules/trackNavLocation.js");
...
_modules_trackNavLocation__WEBPACK_IMPORTED_MODULE_15__["default"].init();
_components_preloader__WEBPACK_IMPORTED_MODULE_8__["default"].init();
_modules_progressBar__WEBPACK_IMPORTED_MODULE_12__["default"].init();
_modules_slowShowText__WEBPACK_IMPORTED_MODULE_13__["default"].init();
...
_components_social__WEBPACK_IMPORTED_MODULE_3__["default"];
_modules_fixedBlockOnMother__WEBPACK_IMPORTED_MODULE_11___default.a;
...
/***/ "./src/js/modules/fixedBlockOnMother.js":
/*!**********************************************!*\
  !*** ./src/js/modules/fixedBlockOnMother.js ***!
  \**********************************************/
...
/***/ "./src/js/modules/slowShowText.js":
/*!****************************************!*\
  !*** ./src/js/modules/slowShowText.js ***!
  \****************************************/
/*! exports provided: default */
...
var init = function init() {
  $(window).on("load", function () {
    $(".js_about_passport_opacity").addClass("is-active");
  });
};
...
/***/ "./src/js/modules/trackNavLocation.js":
/*!********************************************!*\
  !*** ./src/js/modules/trackNavLocation.js ***!
  \********************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
var init = function init() {
  var ancor1 = $('#resume').offset().top;
  var ancor2 = $('#about').offset().top;
  var ancor3 = $('#skills').offset().top;
...
/***/ "./src/js/vendor/jqueryUi_v1.13.1.js":
/*!*******************************************!*\
  !*** ./src/js/vendor/jqueryUi_v1.13.1.js ***!
  \*******************************************/
/*! no exports provided */
...
* Copyright jQuery Foundation and other contributors; Licensed MIT */(function(factory){"use strict";if(typeof define==="function"&&__webpack_require__(/*! !webpack amd options */ "./node_modules/webpack-stream/node_modules/webpack/buildin/amd-options.js")){// AMD. Register as an anonymous module.
define(["jquery"],factory);}else{// Browser globals
factory(jQuery);}})(function($){"use strict";$.ui=$.ui||{};var version=$.ui.version="1.13.1";/*!
...
jQuery.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(_i,name){class2type["[object "+name+"]"]=name.toLowerCase();});function getType(obj){if(obj==null){return obj+"";}return _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(obj)==="object"?class2type[toString.call(obj)]||"object":_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(obj);}function clamp(value,prop,allowEmpty){var type=propTypes[prop.type]||{};if(value==null){return allowEmpty||!prop.def?null:prop.def;}// ~~ is an short way of doing floor for positive numbers
...
if(_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(option)==="object"&&!option.effect){return true;}// Didn't match any standard API
...
if(args.length){options=$.widget.extend.apply(null,[options].concat(args));}this.each(function(){var type=$(this).attr("type");var name=type!=="checkbox"&&type!=="radio"?"button":"checkboxradio";var instance=$.data(this,"ui-"+name);if(instance){instance.option(options||{});if(instance._init){instance._init();}}else{if(name==="button"){orig.call($(this),options);return;}$(this).checkboxradio($.extend({icon:false},options));}});}return returnValue;};}($.fn.button);$.fn.buttonset=function(){if(!$.ui.controlgroup){$.error("Controlgroup widget missing");}if(arguments[0]==="option"&&arguments[1]==="items"&&arguments[2]){return this.controlgroup.apply(this,[arguments[0],"items.button",arguments[2]]);}if(arguments[0]==="option"&&arguments[1]==="items"){return this.controlgroup.apply(this,[arguments[0],"items.button"]);}if(_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(arguments[0])==="object"&&arguments[0].items){arguments[0].items={button:arguments[0].items};}return this.controlgroup.apply(this,arguments);};}var widgetsButton=$.ui.button;/* eslint-disable max-len, camelcase */ /*!
...
}if(inst.inline){this._updateDatepicker(inst);}else{this._hideDatepicker();this._lastInput=inst.input[0];if(_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(inst.input[0])!=="object"){inst.input.trigger("focus");// restore focus
